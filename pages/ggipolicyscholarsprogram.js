...
const ggipolicyscholarsprogram = () => {
  ...
  return (
    <>
      <Head>
        <title>PGP in Public Policy, Governance & Impact by Global Governance Initiative | Learn Policy Skills Live &amp; Get Hired.</title>
        <meta name='description' content="Learn Policy Skills Live, Get Hired, &amp; Network at GGI Policy PGP To Create an Impact in Society &nbsp;" />

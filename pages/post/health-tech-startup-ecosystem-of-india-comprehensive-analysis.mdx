...
<div className="sm:flex gap-5 sm:items-center">
  <img src="    " className="sm:w-34 w-full sm:h-34 " alt="Greeshma" />
  <div className="mt-3">
...
<div className="sm:flex gap-5 sm:items-center">
  <img src="    " className="sm:w-34 w-full sm:h-34 " alt="Shubhendu" />
  <div className="mt-3">
...
<div className="sm:flex gap-5 sm:items-center">
  <img src="    " className="sm:w-34 w-full sm:h-34 " alt="Saravanan" />
  <div className="mt-3">

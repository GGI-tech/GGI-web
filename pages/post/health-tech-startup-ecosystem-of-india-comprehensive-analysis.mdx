...
<div className="w-full sm:flex gap-5 sm:items-center">
  <img src="/6eb651_e71f722c7c5b44d0b87b7071ba1fd10c~mv2.jpg" height={60} width={300} className="" alt="Shubhendu" />
  <div className="mt-3">
...
<br/>
<div className="sm:flex gap-5 sm:items-center">
  <img src="/healthtech1 (2).jpg"  height={60} width={300}  className="" alt="Saravanan" />
  <div className="mt-3">

...
const GGILife = () => {
  ...
  />
      ...
      <section className="mt-[24px] text-center px-6">
        <h2 className="text-4xl font-sans font-bold mt-36 mb-10 text-red-700">Life at GGI</h2>
        <Container>
      ...
      <h2 className="text-4xl mt-36  font-sans font-bold mb-10 text-red-700">Belonging at GGI</h2>
        <Container>
      ...
      <section className="mt-24 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 px-6">
        <div className="bg-white shadow-lg p-6 rounded-lg">
          ...
          <h3 className="mt-4 text-xl font-bold font-sans text-gray-900">Dynamic Learning Environment</h3>
        ...
        <div className="bg-white shadow-lg p-6 rounded-lg">
          ...
          <h3 className="mt-4 text-xl font-bold font-sans text-gray-900">Global Networking</h3>
          <p className="text-gray-700 mt-2">
        ...
        <div className="bg-white shadow-lg p-6 rounded-lg">
          ...
          <h3 className="mt-4 text-xl font-bold font-sans text-gray-900">Real-World Impact</h3>
          <p className="text-gray-700 mt-2">
      ...
      <section className="mt-[12px] text-center px-6">
      <h2 className="text-4xl mt-36 mb-10 font-sans font-bold text-red-700">Learning at GGI</h2>
        <Container>
      ...
      <section className="mt-[12px] text-center px-6">
      <h2 className="text-4xl mt-36 mb-10 font-sans font-bold text-red-700">Life Beyond Classroom</h2>
        <Container>
      ...
      <section className="mt-[12px] text-center px-6">
      <h2 className="text-4xl mt-36 mb-10 font-sans font-bold text-red-700">Join the GGI Family</h2>
        <Container>

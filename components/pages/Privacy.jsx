...
export const Privacy = () => {
  return (
    <div>
        <SlidingHero image={'terms.jpg'} title={["PRIVACY POLICY"]}/>
        <Container>
        <p className="mt-8">The terms &quot;We&quot; / &quot;Us&quot; / &quot;Our&quot;/&quot;Company&quot; individually and collectively refer to Global Governance Initiative (brand of Athenian World Analytics) and the terms &quot;You&quot; /&quot;Your&quot; / &quot;Yourself&quot; refer to the users.</p>
        <p className="mt-8">This Privacy Policy is an electronic record in the form of an electronic contract formed under the information Technology Act, 2000 and the rules made there under and the amended provisions pertaining to electronic documents / records in various statutes as amended by the information Technology Act, 2000. This Privacy Policy does not require any physical, electronic or digital signature.</p>
        <p className="mt-8">This Privacy Policy is a legally binding document between you and Global Governance Initiative. The terms of this Privacy Policy will be effective upon your acceptance of the same (directly or indirectly in electronic form, by clicking on the I accept tab or by use of the website or by other means) and will govern the relationship between you and Global Governance Initiative for your use of the website &quot;Website&quot; .</p>    
        <p className="mt-8">This document is published and shall be construed in accordance with the provisions of the Information Technology (reasonable security practices and procedures and sensitive personal data of information) rules, 2011 under Information Technology Act, 2000; that require publishing of the Privacy Policy for collection, use, storage and transfer of sensitive personal data or information.</p>    
        <p className="mt-8">Please read this Privacy Policy carefully by using the Website, you indicate that you understand, agree and consent to this Privacy Policy. If you do not agree with the terms of this Privacy Policy, please do not use this Website. By providing us your Information or by making use of the facilities provided by the Website, You hereby consent to the collection, storage, processing and transfer of any or all of Your Personal Information and Non-Personal Information by us as specified under this Privacy Policy. You further agree that such collection, use, storage and transfer of Your Information shall not cause any loss or wrongful gain to you or any other person.</p>    
        <p className='font-bold mt-8 mb-3'>1. USER INFORMATION </p>    
        <p>To avail certain services on our Websites, users are required to provide certain information for the registration process namely: - a) your name, b) email address, c) sex, d) age, e) identification number, f) credit card or debit card details g) academic and professional records and history h) sexual orientation, i) biometric information, j) password etc., and / or your occupation, interests, and the like. The Information as supplied by the users enables us to improve our sites and provide you the most user-friendly experience.</p>   
        ...
        <p className='font-bold mt-8 mb-3'>2. COOKIES</p>   
        ...
        <p className='font-bold mt-8 mb-3'>3. LINKS TO THE OTHER SITES</p>   
        ...
        <p className='font-bold mt-8 mb-3'>4. INFORMATION SHARING</p>
        ...
        <p className='font-bold mt-8 mb-3'>5. INFORMATION SECURITY</p>
        ...
        <p className='font-bold mt-8 mb-3'>6. Grievance Redressal</p>
        <p>Redressal Mechanism: Any complaints, abuse or concerns with regards to content and or comment or breach of these terms shall be immediately informed to the designated Grievance Officer as mentioned below via in writing or through email signed with the electronic signature to the Grievance Officer.</p>
        <p>Mr. Grievance Officer</p>
        <p>Email: support@globalgovernanceinitiative.org</p>

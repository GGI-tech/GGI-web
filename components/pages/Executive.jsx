...
const Executive = () => {
    return (
        <div>
            <SlidingHero image={'/smiley-businesswoman-posing-city-with-arms-crossed.jpg'} title={["90 DAYS OF EXECUTIVE MANAGEMENT<br/> & POLICY PROGRAM FOR PROFESSIONALS > 34 YEARS"]} />
            <Link href="#more">
            ...
            <Container>
                <p> 1. If you&#39;re a Senior Professional seeking <span className='primary font-bold'> Alternatives to international MBA</span> programs and want to learn directly from top industry leaders, you&#39;re in the right place.</p><br />
                ...
                <p className='mb-24'>3  . If you&#39;re an <span className='primary font-bold'>aspiring entrepreneur</span> aiming to launch and scale ventures and looking to enhance your business skills while building an incredible support network, you&#39;ve found the right opportunity.</p>
            ...
            <Heading>BENEFITS OF GGI EXECUTIVE MANAGEMENT</Heading>
            <div className="lg:w-2/3 mx-auto text-white italic">
                ...
                <div className="px-2 ylp3 h-60 flex flex-col inset-0 justify-center items-center">
                    ...
                    <p>Throughout the program, you’ll develop deep insights into what it is actually like to work in Consulting Giants and International Affairs</p>
            ...
            <Container> <p >Our competitors charge Rs. 3,00,000 to Rs. 7,00,000. So we decided to try crazy pricing. <span className='font-bold'>We are 80% cheaper than our competitor&#39;s price.</span> We are doing this because we want to make high-quality business and policy education truly accessible to you all and disrupt the space.
                <br /><br />
                Or if you don&#39;t want to commit, we have no questions ask full refund policy within 6 days of enrollment payment, i.e. if you are selected ( we have &lt;10% selection rate). <span className='font-bold'>Either way, you win.</span> To get detailed pricing and information, it is accessible on our application page <u><a href='' target="_blank" rel="noreferrer" >here</a></u></p>
            </Container>

...
const TechMBA = () => {
    ...
    return (
        <>
            <SlidingHero image={'./policy.jpg'} title={[`Join us where Technology and Business intersect<br class='hidden md:block'/> at<span class="text-yellow-200"> GGI Tech-MBA Scholars Program: An AI Focused MBA</span><br class='hidden md:block'/> to Become a Tech Leader for Society `, `<span class="text-yellow-200">GGI Tech-MBA Scholar</span><br/> seeks solutions - from geopolitics to sanctions along with government leaders  `]} />

            <Button page="mpp" url="https://forms.gle/jxT6BKKwd2FpSVAt5"> ADVANCE YOUR CAREER BY APPLYING NOW</Button> {/*to be changed: google form, background image, janmejaya image*/ }
            ...
            <Container>
                ...
                <p>2. You are a non-MPP looking to pivot in Tech & Management roles in firms such as<span className='primary font-bold'> Uber, Amazon, Microsoft, & leading tech startups.</span></p><br />
                <p>3. You are a <span className='primary font-bold'>Pre-MPP </span>with admits to Harvard Kennedy 2+2, Yale Silver Scholars, and other top MPPs and looking to finish the <span className='primary font-bold'>business curriculum with an AI focus, </span> before your program.</p><br />
            ...
            <Container>
                <p>
                GGI Tech MBA Scholars community comprises an extremely diverse cohort -  from BTech at IIT&#39;s and YIF at Ashoka to Masters at TISS and the MIT. A few of the Tech-MBA scholars are working professionals in organizations such as Pratham, Google, Uber, Teach for India, NITI Aayog, Hindustan Times and other leading education NGOs.
                </p>
            </Container>
            ...
            <Container>
                <p className='mb-2'>Through teaching, public sector knowledge, tech fundamentals,statistics, Python coding, change theories, data analytics and engagement with government and tech practitioners, GGI Tech MBA Scholar during GGI Tech MBA will provide an AI-focused MBA and public leadership through tech so that people can live in societies that are safer, freer, juster, and more sustainably prosperous. Our practitioner&apos;s focus on economic, technology, Artificial Intelligence, Machine Learning, Extremism, sustainability, and your public leadership practice.   </p>
                <p>Leaders looking to pivot into the world of Tech MBA, tech for good, social impact, international affairs and Product Management should be able to successfully navigate different cultures, economies, governments, and jobs. To help GGI Tech MBA Scholars develop these crucial abilities, GGI has carefully curated a portfolio of immersive, experiential programs that take place across the technology and public policy domain.  <span className='font-bold'>This is achieved in 3 stages during the 3-6 months  : </span> </p>
            </Container>
            <Steps data={stages} />
            ...
            <Container> <p >Our competitors charge Rs. 3,00,000 to Rs. 7,00,000. So we decided to try crazy pricing. <span className='font-bold'>We are 80% cheaper than our competitor&#39;s price.</span> We are doing this because we want to make high-quality business and policy education truly accessible to you all and disrupt the space.
                <br /><br />
                Or if you don&#39;t want to commit, we have no questions ask full refund policy within 6 days of enrollment payment, i.e. if you are selected ( we have &lt;10% selection rate). <span className='font-bold'>Either way, you win.</span> To get detailed pricing and information, it is accessible on our application page <u><a href='https://forms.gle/jxT6BKKwd2FpSVAt5' target="_blank" rel="noreferrer" >here</a></u></p>
            </Container>

...
const data3 = [
    {
        "id": 1,
        "title": `<a href="https://www.linkedin.com/in/averi-chakraborty/" rel="noreferrer noopener" target="_blank">Averi Chakraborty </a>`,
        "org":"Boston Consulting Group",
        "img": "/averi.jpg",
    ...
    {
        "id": 2,
        "title": `<a href="https://www.linkedin.com/in/aditya510/" rel="noreferrer noopener" target="_blank">Aditya Bansal</a>`,
        "org":"Bain &amp; Company",
        "img": "/aditya.jpg",
    ...
    {
        "id": 5,
        "title": `<a href="https://www.linkedin.com/in/rahul-prasad-289422178/" rel="noreferrer noopener" target="_blank">Rahul Prasad</a>`,
        "org":"Kearney India",
        "img": "/rahul.jpg",
    ...
    {
        "id": 6,
        "title": `<a href="https://www.linkedin.com/in/swatisachdeva-/" rel="noreferrer noopener" target="_blank">Swati Sureka </a>`,
            ...
            <div className='mx-4 my-12 flex flex-col lg:flex-row justify-evenly  py-5 border border-black/10 shadow-black/5 shadow-xl rounded-lg'>
                <div className='flex justify-center'>
                    <div className='text-center p-4'>
                        ...
                        <p className='my-2 font-bold text-gray-900 dark:text-white  ' dangerouslySetInnerHTML={{ __html: title }}></p>
    ...
    return (
        <>
            ...
            <div className='mt-24 grid grid-cols-1 sm:grid-cols-2 sm:mx-12'>
                ...
                {data1.map((e) => {
                    return (
                        <Card key={e.id} org={e.org} title={e.title} img={e.img} text={e.text} />

                ...
                <div className='col-span-3'>
                    <div className='r2 flex mt-12 md:mt-24 gap-1 md:gap-10  text-center justify-evenly sm:justify-between flex-wrap'> {/*bg-blue-900 */}
                        <h1 className='relative text-2xl sm:text-3xl arial  py-3 sm:py-6 '>
                            ...
                            MANAGEMENT <br className='hide' /><span className='text-2xl sm:text-3xl lg:text-5xl'>CONSULTING </span></h1>
                        <h1 className='relative text-2xl sm:text-3xl arial py-3 sm:py-6'>PUBLIC <br className='hide' /><span className=' text-2xl sm:text-3xl lg:text-5xl'> POLICY <img width={50} height={80} src='/arrow.jpg' className='hidden sm:block absolute top-0 -right-14 lg:-top-2 lg:-right-5' />
                        </span></h1>
                    </div>
                    <div className='r3 mt-4 sm:mt-5 flex flex-wrap lg:flex-nowrap gap-5 md:gap-10 justify-center lg:justify-start items-end '> {/*bg-green-300*/}
                        <div className=''>
                            <div className='flex sm:mt-4 justify-center'>
                                <h1 className='relative text-2xl sm:text-3xl lg:text-5xl arial'>PRODUCT<img width={50} height={80} src='/arrow.jpg' className='absolute hidden sm:block bottom-12 left-72' /><br className='hide' /><span className='text-2xl sm:text-4xl'> MANAGEMENT </span></h1>
                            </div>

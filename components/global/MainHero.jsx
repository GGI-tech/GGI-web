...
const MainHero = () => {
    return (
        <div className='hero  text-white flex-col pt-36 md:pt-24 px-2 md:px-24 h-full'>
            <div className='r1 flex gap-5 justify-center md:justify-start items-end flex-wrap'>
            ...
            <div className='r2 flex justify-between mt-4 flex-wrap'>
                <h1 className='text-3xl font-black max-w-xs'>MANAGEMENT CONSULTING</h1>
                <h1 className='text-3xl font-black max-w-xs'>PUBLIC POLICY</h1>
            </div>
            <div className='r3 flex justify-center flex-wrap lg:flex-nowrap'>
                <div className=''>

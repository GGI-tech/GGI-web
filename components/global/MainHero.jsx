    ...
    return (
        <div className={`hero text-white flex-col ${secondarynavbar ? 'mt-20 sm:mt-12' : 'mt-4 lg:mt-auto'} pt-24 px-2 sm:px-12 lg:px-24 xl:px-36 h-full`}>
            <div className='r1 flex gap-5 md:gap-10 justify-center lg:justify-start  items-end flex-wrap lg:flex-nowrap'> {/*bg-purple-500 */}
                <h1 className='text-6xl md:text-8xl lg:text-9xl font-black '>100X</h1>
            ...
            <div className='grid md:grid-cols-4 grid-cols-3 pb-8'>{/*bg-black*/}
                <div className='col-span-3'>
                    <div className='r2 flex mt-5 gap-1 md:gap-10  text-center justify-evenly sm:justify-between flex-wrap'> {/*bg-blue-900 */}
                        ...
                        <h1 className='relative text-2xl sm:text-3xl font-black py-3 sm:py-6'>PUBLIC <br className='hide' /><span className=' text-2xl sm:text-4xl'> POLICY <img width={50} height={80} src='/arrow.jpg' className='hidden sm:block absolute top-0 ' />
                        </span></h1>
                    </div>
                    <div className='r3 mt-4 sm:mt-5 flex flex-wrap lg:flex-nowrap gap-5 md:gap-10 justify-center lg:justify-start items-end '> {/*bg-green-300*/}
                        <div className=''>
                            <div className='flex sm:mt-4 justify-center'>
                                <h1 className='relative text-2xl sm:text-3xl font-black'>PRODUCT<img width={50} height={80} src='/arrow.jpg' className='absolute hidden sm:block bottom-12 ' /><br className='hide' /><span className='text-2xl sm:text-4xl'> MANAGEMENT </span></h1>
                            </div>

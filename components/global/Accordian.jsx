...
const FAQ = [
    {
        ...
        <br><br> 
        E.&nbsp;<u><a href="/executivemanagement" target="_blank" rel="noreferrer noopener">GGI Executive Leaders</a></u>- Serves as a <span style="font-weight:bold;">&nbsp;classic Executive MBA,</span> designed specifically for those looking for brakthrough learnings for leaders and looking to get into<span style="font-weight:bold;"> general management, strategy</span> and <span style="font-weight:bold;"> policy.</span></span><br><br>
        F.&nbsp;<u><a href="https://www.globalgovernanceinitiative.org/tech-mba" target="_blank" rel="noreferrer noopener">GGI Tech MBA</a></u>- Serves as a classic<span style="font-weight:bold;">&nbsp; Alt Tech MBA & Pre Tech MBA,</span> designed specifically for those who wish to pivot their career into tech product management, Business Technology and Artificial Intelligence. </span></span><br><br>
        G.&nbsp;<u><a href="https://www.globaltechinitiative.org/feynmanfellowship" target="_blank" rel="noreferrer noopener">GTI Feynman Fellowship-</a></u>- Serves as a classic experiential learning and work-study model, designed specifically for those who are exploring looking to pivot their career into<span style="font-weight:bold;">&nbsp;Artificial Intelligence/Tech Product Management</span>  as you work on small group personalized projects with mentors from Industry. </span></span>`

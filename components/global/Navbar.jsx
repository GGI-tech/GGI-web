...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      <div className='sm:mx-12 m-auto flex justify-between gap-2 items-center text-white pr-5 lg:pr-32 '>
        ...
        <ul style={{ color: `${textColor}` }} className='font-semibold hidden sm:flex md:text-[16px] '>

...
export const fivecolumndata = [ //to be fetched from database
    {
        ...
        "body": "Receive personalized guidance from industry leaders on balancing career growth with the unique challenges of pregnancy and postpartum transitions. "
    },
    {
        "id": 2,
        "img": teach,
        "title": "Do Live Consulting Project & Write Consulting Paper",
        "body": "As a GGI Curie Fellow, you will learn consulting practices by actually advising real clients in this country and writing a consulting-style research paper, thereby increasing your skills and enhancing your profile."
    },
    {
        "id": 3,
        "img": clinton,
        "title": "Career Advancement with Family-Friendly Employers",
        "body": "Benefit from GGI's partnerships with organizations that prioritize work-life balance and support for women during pregnancy and postpartum."
    },
    {
        "id": 4,
        "img": network,
        "title": "Become Part of a Supportive, Empowering  Community",
        "body": "Connect with a global network of women and allies who support each other through career challenges, pregnancy, and postpartum transitions."
    }
    ,
    {
        "id": 5,
        ...
        "body": "Access free weekly deep dive sessions for two months post-graduation, focusing on current business trends and strategies for managing work-life integration during motherhood."
    }
]
export const stages = [
    {
        "id": 0,
        "ques": "Stage 1 - Upskilling, Skill Reintegration & Confidence Building",
        "ans": ["<p className='mb-2'>Context is a critical component of sound decision-making in consulting and international development. GGI prepares Curie Fellows to be future women leaders by honing skills that enable them to connect the dots across various areas, including policy consulting, management consulting and sustainability, product management and tech ethics, impact investing, liberal arts, and core business perspectives, through GGI&#39;s trademarked Masterclasses, designed to accomodate the unique needs of women planning for pregnancy or navigating postpartum challenges. ", `</p><br><p className='mb-3'>In this stage, Curie Fellows, during their executive education, also have access to the personalized Career Development Program of the Global Governance Initiative. This component is crucial for those aiming to work in organizations like McKinsey, BCG, Bain, United Nations, World Bank, and others. Many Masterclasses are typically led by incumbent partners and leaders of such organizations.
            </p><br><p className='mb-3'> The Career Development Program comprises two pillars:</p>
                    <p class='text-xl font-semibold my-4'>1. Hands-on Case Solving Sessions (Unique for every learner):  </p><p>GGI Curie Fellows learn the art and science of problem-solving in a closed ecosystem, along with CV and cover letter hacks. The mentors leading these sessions are handpicked from top organizations such as McKinsey, BCG, Bain, United Nations, Tesla, etc.
                    ...
                    <br><br>                    
                    During their executive education, GGI Curie Fellows are also integrated into a rotating buddy system, where they practice cases, network on Wiggly, and build bonds with other members of this exceptional community at the Global Governance Initiative.
 </p>`]
    },
    {
        "id": 1,
        "ques": "Stage 2 -  Inclusive and Bias-Free Employment Pathways<br/> &<br/> Skin in the Game ",
        "ans": ["<p className='mb-3'>To truly understand the world, you must have skin in the game. The realms of Consulting and International Development are unpredictable and adventurous. Curie Fellows are placed in situations where they refine their skills by publishing consulting-style research papers under the Council on Sustainable Development.", "  </p><br><p className='mb-3'>They engage in hands-on consulting projects and research that value inclusivity and support for women balancing career ambitions with family planning and motherhood.</p><br> <p className='mb-3'>Thanks to the experiential learning component, Curie Fellows can successfully outshine others in their consulting interviews.  </p>"]
    },
    {
        "id": 2,
...
export const curriculum=[
    {
        "title":"A 1 year long, flexible Program",
        "description":"Program duration tailored to accommodate personal, family, and professional commitments"
    },
    {
        "title":"90+ Hours of Skill-Building Masterclasses",
        "description":"Focused sessions to address technical skill gaps and build confidence in re-entering the workforce."
    },
    {
        "title":"Consulting Paper with MBB mentor",
        "description":"Hands-on projects designed to help participants regain industry relevance while balancing motherhood"
    },
    {
        "title":"115+ Bias-Free Employment Partnerships",
        "description":"Connections with family-friendly employers dedicated to providing equal opportunities for mothers returning to work."
    },
    {
        "title":"Mental Health and Networking Support",
        "description":"Resources and community events centered on emotional well-being and rebuilding professional networks"
    },
    {

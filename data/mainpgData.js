...
export const fourcolumndata = [ //to be fetched from database
  {
    "id": 1,
    "img": harvardcase,
    "title": "Harvard-Style, Case-Driven masterclasses.",
  ...
  },
  {
    "id": 2,
    "img": officeofcareer,
    "title": "Guided by mentors from McKinsey, BCG, Dalberg, and the UN.",
  ...
  },
  {
    "id": 3,
    "img": leadingpurpose,
    "title": "Focused on execution - not theory.",
  ...
  },
  {
    "id": 4,
    "img": becomepart,
    "title": "Rooted in community - not competition.",
...
export const stages = [
    {
        ...
        "ans": ["<p className='mb-2'>Build foundations in consulting, policy design, and strategic communication.", `</p>`]
    },
    {
        "id": 1,
        "ques": "Stage 2 - Apply ",
        "ans": ["<p className='mb-3'>Work on live cases with real mentors and organizations.", "  </p><br>"]
    },
    {
        "id": 2,
        "ques": "Stage 3 - Accelerate ",
        "ans": [
            "<p>Publish, pitch, and pivot - join GGI’s 100+ hiring partners in consulting, product, or impact roles.</p>",
            ""
          ] }
]


export const testimonialMainFellows = [
  {
    name: 'Darshita Devnani',
    org: '<b>Asian Development Bank (ADB)</b> <br>GGI Fellow, 2021',
    image: '/darshita2.jpg',
  ...
  },
  {
    ...
    org: '<b>Kearney Consulting</b><br/>GGI Delegate, Policy Consulting Cohort, 2019 <br> Shri Ram College of Commerce (SRCC)',
    image: '/tusharnew.jpg',
  ...
  {
    name: 'NISHTHA GUPTA',
    org: '<b>Boston Consulting Group (BCG)</b><br/>GGI Delegate, Policy Consulting Cohort, 2019 <br> Indian Institute of Technology (IIT), Delhi',
    image: '/Schermata.jpg',
  ...
  },
  {
    ...
    org: '<b>BCG | Samagra</b><br/>GGI Fellow<br> Lady ShriRam College for Women (LSR)',
    image: '/anusha.jpg',
  ...
  {
    name: 'CHIRAG MITTAL',
    org: '<b>Boston Consulting Group (BCG)</b><br/>GGI Delegate, Policy Consulting Cohort, 2019<br>Indian Institute of Management (IIM), Bangalore',
    image: '/chirag.jpg',
  ...
  {
    name: 'AAYUSHI DHAWAN',
    org: '<b>QCI</b><br/>GGI Policy Fellow, Policy Consulting Cohort, 2019<br> Delhi School of Economics',
    image: '/aayushi.jpg',
...
export const testimonialMain2 = [
  {
    ...
    Today, I’m joining <span class='font-bold'>Bain & Company</span> with the confidence and clarity that came from those shared challenges and perspectives.`
  },
  {
    name: 'ANAMITRA MUNSI',
    org: '<b>Boston Consulting Group (BCG)</b> <br>ISB Hyderabad<br/>GGI PGP Scholar, 2021',
    ...
    More than anything, GGI taught me how to restart with purpose.`
  },
  {
    name: 'SHREYA SAPRU',
    org: '<b>Samagra</b><br/>GGI PGP IMPACT SCHOLAR<br> NIT',
    ...
    It wasn’t just a program - it was a mindset shift.`
  },
  {
    name: 'SWATI SUREKA',

...
export const fourcolumndata = [
    ...
    },
    {
        ...
        "body": "GGI has forged strong employment partnerships with leading organizations for talent, who are always looking for tech talent. "
    },
    {
        "id": 3,
        "img": network,
...
export const stages = [
    {
        ...
        "ans": [` <p class='mb-2'>Context is a critical component of sound decision-making in the world of Architecture Design, Software Engineering and Machine Learning - and breadth of knowledge is what creates a great analytical thinker and a leader. GGI prepares ALT IIT Scholars to be future leaders by honing skills that allow them to connect the dots across many areas including architecture Design, data structures and algorithms, Software Engineering and Machine Learning ,and core problem solving perspectives - Via GGI&#39;s trademarked Masterclasses. </p>`,
            `<p class='mb-2'>In this stage, GGIs Alt IIT scholars will attend the<span class='font-semibold'> 80+ hours of interactive Masterclasses </span>(including the Mandatory Data Strcutures and Algorithms Masterclass) along with evaluative peer assignments. In order for the scholars to interact with tech leaders, ALT IIT scholars will also be provided unlimited exclusive access to renowned Guest Speaker&#39;s Masterclasses. </p>
                <p class='mb-2'>Many of the Masterclasses are anchored by Incumbent CTOs and CPOs of tech startup firms, startups, and leading product-based Organizations. Over and above the Masterclasses, GGI Scholars indulge in peer to peer-based post Masterclass assignments, projects, and startup weekend to apply the learnings on real practical problems. </p>
                <p class='mb-2'>The ALT IIT will teach the core programming language fundamentals in 10 hours, and these principles will be applied across Masterclasses in Software and System Design,data structures, Specialization programming, etc. For the IIT admits, MIT Boston, and other deferred IIT admits- this stage will ensure that you have touched the basics of core courses before the start of your IIT Engineering Program - completion of this stage will save time to effectively engage in networking on Wiggly during your Engineering. For the working professionals, this will stage allow you to solve problems with contextual intelligence from across the sectors in their day job. </p>`
        ]
    },
    {
        "id": 1,
        "ques": "STAGE 2 - Access to Employment Partnerships <br/>& Microexperential learning in Consulting & PM and the Buddy Network",
        "ans": [`<p class='mb-2'>GGI Scholars will also be made part of a rotating buddy system - where they can practice cases, build a community, bond, and network with other members on Wiggly of the incredibly diverse communities at Global Governance Initiative.</p>`]
    },
    {
        "id": 2,
        ...
        <p class='mb-2'>Even though the journey of an ALT IIT Scholar formally ends in 3 months. But Scholars - as GGI Alumni will always have access to the inclusive, supportive, respectful, and collaborative ecosystem of the Global Governance Initiative for the rest of their lives. GGI PGP Scholars also enjoy access to the exclusive partnerships that GGI continuously builds with leading organizations, Tech Schools. </p>
        <p class='mb-2'>GGI ALT IIT Scholars is Crème de la crème of the Global Governance Initiative network on &apos;wiggly&apos;. Through core Masterclasses, flexible curriculum, Networking Nights, AI Tools - the ALT IIT Program provides a wide view into the world of Tech, System Design, Programming, and Architecture. </p>
        <p class='mb-2'>ALT IIT Scholars are also made part of the GGI's Growing network through its various technology portals that comprise an international and diverse network at &apos;wiggly&apos; of GGI Delegates, PGP Scholars, Policy Scholars, Fellows, and mentors spread across 4 continents.</p>
`]
    }
...
export const curriculum = [
    ...
    {
        "title": "70+ Hours of Tech Masterclasses",
    ...
    },
    {
        ...
        "description": "During graduation. 1 to take forward your Tech dreams "
    },
    {

import network from '../public/network-new.jpg'
import sb1 from '../public/sb1.png'
import intern from '../public/intern-new.png'
import rjgupta from '../public/rajat_new.png'
...
export const fourcolumndata2 = [
    {
        "id": 1,
        "img": swan,
        "title": "Black Swan Bootcamp",
        "body": "Weekly crisis drills that train you to lead confidently through chaos."
    },
    {
        "id": 2,
        "img": cas,
        "title": "Case Method 2.0 and Cold Call Trainings",
        "body": "Solve real-world challenges with incomplete data and relentless time pressure along with High-stakes Q&A simulations that sharpen your thinking on the spot."
    },
    {
        "id": 3,
        "img": stress,
...
export const testimonialMBA = [
    ...
    {
        name: "Rishabh Jain",
        org: "<b>AT Kearney Consulting | InMobi</b>",
        image: "/rishabh.jpg",
        review: "Shortly after GGI, I bagged an offer from <span class='font-bold'>InMobi for the profile of a Business Analyst</span> in their Bangalore office. Two weeks into the GGI Fellowship, and I bagged this offer.<br><br>Being mentored by leaders like Shatakshi Sharma and Naman Shrivastava at such a young age is no less than a blessing. GGI helped me discover my true self and transform into a mature individual from a college-going &lsquo;kid&rsquo;."
    },
     {
    name: 'Karan David',
    org: '<b>Bain & Company | Yale University</b><br/>GGI Delegate, Policy Consulting Masterclass Cohort, 2019<br>St. Stephen&#39;s College',
    image: '/karan.jpg',
    ...
    {
    name: 'TUSHAR GOPALKA',
    org: '<b>Boston Consulting Group (BCG) | UCLA</b> <br>GGI Impact Fellowship Scholar, 2024',
    image: '/tushar.png',
    ...
    {
        name: "Kalash Verma",
        org: "<b>McKinsey & Company</b>",
        image: "/kalash.jpeg",
        review: "I am a final-year student at Indian Institute of Technology, Madras. Shortly after GGI, I will be joining <span class='font-bold'>McKinsey & Company</span>. <br><br> I found out about GGI when I was unclear about what I wanted to do in life albeit I had figured out where my general interests lay. <br> That&apos;s when I searched on the internet and found out about GGI.<br> I signed up for GGI as I knew GGI would be a great platform to understand what I exactly wanted to do in the future as well as up-skill myself and meet great people. &ldquo;"
    },
    {
        name: " JAYESH JAWANDHIA",
        org: "<b>BCG</b>",
        image: "/Jayesh.jpg",
        review: "Hey Shatakshi, I'll be joining <span class='font-bold'>BCG</span> next month. <br><br> Thank you so much for all the help, couldn't have been possible without you and GGI. It was a great learning experience"
    },
    {
        name: 'Ansh Aggarwal',
    org: '<b>McKinsey & Company</b><br/>GGI Delegate, Policy Consulting Masterclass Cohort, 2019<br/> Shri Ram College of Commerce (SRCC)',
    image: '/ansh.jpg',
    review: "Shortly after GGI, I got placed in <span class='font-bold'>McKinsey & Company</span>. In fact, I will be moving to Mumbai to work as a Business Analyst. Also after the masterclass, having won the <span class='font-bold'>EY Scholarship for entrepreneurship,</span> I completed an internship at <span class='font-bold'>EY</span> as well.<br> <br>Amongst all the sectors, I am especially excited to contribute to the public sector and private equity verticals at McKinsey. GGI&#39;s prestigious Policy Consulting Masterclass definitely helped me navigate through the recruitment process. :)"
...

      {
        ...
        org: '<b>INSEAD, MBA</b> <br/> GGI Impact Fellow',
        image: '/ayushsingh.PNG',
        review: "Hi, I am Aayushman from Delhi, And I&apos;ll be joining INSEAD this fall.<span class='font-bold'> I had updated my application to INSEAD with my GGI Impact Fellowship offer, post which within few days I was also invited to join INSEAD.</span> I completed civil engineering from University of Hong Kong.<br><br>I had a brief stint in entrepreneurship, after which I started working in a Fortune 500 infrastructure consulting firm. I have over 6 years of experience in this space. I wanted to pivot to management consulting post MBA. Last year and that is when I found out about GGI"
      },
      {
        name: 'Arpita',
        org: '<b>Deloitte | INSEAD, MBA</b> <br/>GGI Impact Fellow',
        image: '/arpita.jpg',
        review: "Arpita is currently an Associate Solution Advisor in the Cyber Risk Advisory practice of<span class='font-bold'> Deloitte</span><br/><br/> An Electronics & Telecommunications Engineer from Army Institute of Technology, Pune, Arpita has previously worked in the fields of Financial Crimes Prevention, Anti-Money Laundering and Regulatory reporting.<br/><br/> <span class='font-bold'>The things I loved the most about GGI are the community, the people and just the power of a really strong network- how to build one, how to nurture one. Through GGI, I was exposed to a spectrum of topics, ranging from Tech Ethics to Liberal Arts to Policy Consulting and even Management Communications. <br/><br/>Last but not the least, I learned how to build a personal brand and how to stay true to yourself :)</span>"
      },
      {
        name: 'Oliviya Brar',
        org: '<b>BCG | INSEAD MBA </b><br/> GGI Impact Fellow',
        image: '/oli.jpg',
    ...
    review: "Shortly after GGI, I joined <span class='font-bold'>Samagra | Transforming governance.</span> I would definitely like to say that in my entire process of going through interview rounds and even otherwise, I had structured my answers and GGI definitely has had a big role to play.<br><br> During my written round interview with OSD to Jayant Sinha also, I was asked an assignment, one of which had to do with mitigation of climate change- a topic my team and I had worked on this particular topic on a GGIprojects- so that really helped me because I already had a perspective on what the issue was and I could structure my answer- given the limited time frame I had.<br><br>   Shatakshi was also kind enough to respond to my emails throughout my rounds and guided me factors that would majorly play a role"
      ...
      {
        name: 'Ronak Agarwal',
        org: '<b>McKinsey, Wharton MBA</b><br/><br/> GGI Impact Fellow',
        image: '/ronakag.jpg',
        review: ""
      },
      {
    ...
    GGI wasn’t just a chapter; it was the start of everything that followed.`
  },
     
    {
        name: 'Patrick Makwe Rankhumise',
        org: '<b>University of Cape Town</b><br/>GGI Global Leadership Scholar 2023',
    ...
    {
        name: 'Priyal Keni',
        org: '<b>Deloitte Consulting</b><br/>GGI Management PGP Scholar 2021',
    ...
    {
        name: 'Sanni',
        org: '<b>Columbia University</b><br/>GGI Global Leadership Scholar 2023',
        link: '',
        image: '/sanni.jpeg',
    ...
    {
        name: 'Anisha Sawhney',
        org: ' <b>University of Warwick</b><br/>GGI Management PGP Scholar 2021.',
    ...
    {
        name: 'Ronak Batra',
        org: '<b>ThreeFish Consulting</b><br/>GGI Management PGP Scholar 2021.',
    ...
    {
        name: 'Dhruv Goyal',
        org: 'GGI Management PGP Scholar 2021.',
    ...
    {
        name: 'Abhinav Srijan',
        org: '<b>Northeastern University</b><br/>GGI Management PGP Scholar 2021.',
    ...
    },
    {
        ...
        org: '<b>IIT Kharagpur </b><br/>GGI Management PGP Scholar 2021.',
    ...
    },
    {
        ...
        org: '<b>King&39;s College London | St. Stephen&39;s College</b><br/>GGI Management PGP Scholar 2021.',
    ...
    {
        name: 'Jigyasa Sidana',
        org: '<b>Shri Ram College of Commerce (SRCC) </b><br/>GGI Management PGP Scholar 2021.',
    ...
    {
        name: 'Saakshi More',
        org: '<b>LSR</b> <br/>GGI Management PGP Scholar 2021.',
    ...
    org: '<b>National University of Singapore</b>',
    ...
    org: '<b>University of British Columbia</b>',
    ...
    org: '<b>Dept. of Justice, Philippines</b>',
    image: '/janmarie.png',
    ...
    review: "Karabo is born and raised in Johannesburg, South Africa. An interest in locally relevant knowledge generation led Karabo to pursue his tertiary education in the sciences with the University of Cape Town, where he is currently wrapping up his Masters in Bioinformatics.<br/><br/>His research aims to gain insight into the unique genetic and molecular traits of lung cancer among patients of African Ancestry.<br/><br/>As a Global Leadership Scholar with GGI, Karabo has been upskilling himself so that he can successfully make this exciting career change."
      ...
      {
    name: 'JACK WINKLES',
    org: '<b>Top 10 Engineering and Construction undergraduates of the year 2019</b> <br/>GGI delegate- Startup Masterclass Cohort, 2019',
    image: '/jack.jpg',
    review: "I&#39;ve spent my weekend completing a business startup masterclass with GGI, listening to multiple speakers, and learning what it takes to successfully create and kick start a business. Although it meant starting at 5.30 am on Saturday and 3 am this morning, it was absolutely worth it! <br><br>  Massive thank you to Shatakshi Sharma and Naman Shrivastava for creating this initiative and helping me realize my dreams. I will absolutely keep going to get my business startup up and running."
      ...
      {
    name: 'ALEXIS PELLIER',
    org: '<b>Sciences Po</b><br/>GGI delegate- Impact Startup Cohort, 2020',
    image: '/alexis.jpg',

...
export const stages = [
    {
        ...
        "ans": [`<p class='mb-4'>Today research and data-oriented policy-making is a critical component of sound decision-making in the world of Policy consulting, and social impact- and learning to navigate amidst the breadth of knowledge is what creates a great analytical policy thinker and a leader. GGI prepares Policy Scholars to be future leaders by honing skills that allow them to connect the dots across many areas including macroeconomics, emerging technologies such as AI, public market failures, liberal arts, financial inclusion, sustainability, responsible investing, ethics, energy, climate impact, and core policy perspectives - Via GGI&#39;s trademarked Masterclasses.  </p>
            `, ` <p class='mb-4'>In this stage, GGI&#39;s Policy scholars will attend the 50 hours of Masterclasses in order for the scholars to interact with key government leaders and practitioners, policy scholars will also be provided unlimited exclusive access to renowned Guest Speakers Masterclasses.  </p>
    ...
    },
    {
        ...
        "ans": [`<p class='mb-4'>Global Governance Initiative has crafted and designed (now licensed and patented) microlearning AI-based experience via Schrödinger. It is an interactive real-life case simulator that allows GGI Scholars to practice cases and interviews at a time that works best for them. </p>
            ...
            <p class='mb-4'>GGI Scholars will also be made part of a rotating buddy system - where they can practice cases, build a community, bond, and network with other members on Wiggly of the incredibly diverse communities at Global Governance Initiative. </p>`]
    },
    {
        "id": 2,
        ...
        "ans": [`<p class='mb-4'>It is often said that if you have nothing in your life, but you have at least one person who cares for you unconditionally, it will do wonders for your self-esteem. For GGI Scholars that one person is the entire community at Global Governance Initiative. </p>
            ...
            <p class='mb-4'>An MBA degree is more than learning valuations and Little’s Law. You pay for the entire experience - the guest speakers, office hours with your professors, campus events, and eventually landing the job of your dreams. It is an experience of a lifetime. </p>
            ...
            <p class='mb-4'>GGI Impact MBA Scholars is Crème de la crème of the Global Governance Initiative network on &#34;wiggly&#34;. Through core Masterclasses, flexible curriculum, Networking Nights, AI Tools - Impact MBA scholars Program provides a wide view into the world of social Impact Consulting, Management consulting, and Product Management. </p>
            <p class='mb-4'>Impact MBA Scholars are also made part of the GGI&#39;s Growing network through its various technology portals that comprise an international and diverse network at &#34;wiggly&#34; of GGI Delegates, Impact Scholars, Policy Scholars, Tech MBA Scholars, Fellows, and mentors spread across 4 continents. </p>
`]
    }
